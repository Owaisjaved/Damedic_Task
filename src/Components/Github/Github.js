              ...
              <div className="Repo-Cards" key={item.id}>
                ...
                <div className="repo-info">
                  ...
                  <div className="smallText customAlign ">
                    <img src="/icons/star.png" width="16px" alt="starIcon"></img>
                    {item.stargazerCount}
                  </div>
                  <div className="smallText customAlign">
                    <img src="/icons/code.png" width="16px" alt="codeIcon"></img>
                    {item.forkCount}
                  </div>
                  <div className="smallText customAlign">
                      Ratio{" "}
                      {/* { ((item.forkCount/item.stargazerCount)*100)===NaN? 0 : Math.abs((item.forkCount/item.stargazerCount)*100).toFixed(2)}% */}
                      {item.forkCount===0 && item.stargazerCount===0 ? 0.00: Math.abs((item.forkCount/item.stargazerCount)*100).toFixed(2)}% 
                    </div>
                  <div className="smallText">
